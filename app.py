...
with row1_1:
    st.markdown('<h2 style="text-align: justify;"></h2>', unsafe_allow_html=True)
    st.markdown('<h2 style="text-align: justify;"></h2>', unsafe_allow_html=True)
    st.markdown('<h2 style="text-align: center;">¿Quiénes somos?</h2>', unsafe_allow_html=True)
    #st.markdown('<h2 style="text-align: center;">somos?</h2>', unsafe_allow_html=True)
with row1_2:
    st.markdown('<h4 style="text-align: justify;">Somos un grupo de profesionales con amplia experiencia en análisis de datos, procesos empresariales y transformación digital en Latinoamérica. Provenientes de áreas variadas, pero con la misma vocación y pasión por la mejora de procesos de negocio</h4>', unsafe_allow_html=True)
    st.markdown('<h4 style="text-align: justify;">Ofrecemos a nuestros clientes una variedad de servicios para asegurar que sus decisiones se basen en información precisa y veraz. Esto nos permite brindarles una visión integral para ayudar a las personas en la comprensión de su propio negocio y en la adopción de las mejores estrategias de gestión.</h4>', unsafe_allow_html=True)
col1, col2, col3 = st.columns(3)

with col2:
    st.markdown('<h2 style="text-align: center;">SERVICIOS</h2>', unsafe_allow_html=True)

col4, col5, col6 = st.columns(3)
with col4:
    st.image("https://www.esan.edu.pe/images/blog/2015/06/18/data-warehouse-mart-figura-principal.jpg",width=370)
    st.markdown('<h3 style="text-align: center;">Extracción de Datos</h3>', unsafe_allow_html=True)
    st.markdown('<h5 style="text-align: justify;">Recolectamos grandes volúmenes de datos desde diversas fuentes y los almacenamos en una única base de datos para su posterior procesamiento y análisis.</h5>', unsafe_allow_html=True)

with col5:
    st.image("https://h3d9f2s8.rocketcdn.me/wp-content/uploads/2022/08/Power-BI-Dashboard.png",width=370)
    st.markdown('<h3 style="text-align: center;">Visualización de Datos</h3>', unsafe_allow_html=True)
    st.markdown('<h5 style="text-align: justify;">Combinamos la exploración y el análisis de los datos con herramientas de visualización que nos permitan identificar tendencias y patrones para revelar insights de valor</h5>', unsafe_allow_html=True)
...
with col6:
    ...
    st.markdown('<h5 style="text-align: justify;">Recomendamos en función a las necesidades del negocio el/los algoritmos de machine learning que ayuden a la toma de decisiones e implementamos dicha solución</h5>', unsafe_allow_html=True)

col7, col8, col9 = st.columns(3)
with col8:
    st.markdown('<h2 style="text-align: center;">PROYECTOS</h2>', unsafe_allow_html=True)
    
row2_spacer1, row2_1, row2_spacer2 = st.columns((.2, 7.1, .2))   
with row2_1:    
    st.markdown('<h3 style="text-align: center;">Análisis de Reviews de Google Sector Hotelero de EEUU</h3>', unsafe_allow_html=True)
    st.markdown('<h5 style="text-align: justify;">PCA DATA procesa y analiza de manera eficiente la información proveniente de las reseñas de los usuarios del sector hotelero de Estados Unidos para que de esta manera los gerentes puedan tomar decisiones eficientes en materia de inversión y gestión. Ayudándolos a elegir ubicaciones valiosas para instalar nuevas dependencias y por lo tanto disminuir riesgos de inversión así como mejorar la calidad de sus servicios y ofrecer mejores experiencias para los usuarios, obteniendo de ésta manera una ventaja competitiva</h5>', unsafe_allow_html=True)
    st.markdown('<h4 style="text-align: center;">Repositorio en <a href="https://github.com/HenryGrupo07/TrabajoGrupal">Hotel Recommendation</a></h4>', unsafe_allow_html=True)
